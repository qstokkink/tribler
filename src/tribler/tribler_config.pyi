...
class TriblerConfigManager:
    ...
    @overload
    def set(self, option: Literal["libtorrent/i2p"], value: bool) -> None: ...
    @overload
    def set(self, option: Literal["libtorrent/i2p_hostname"], value: str) -> None: ...
    @overload
    def set(self, option: Literal["libtorrent/i2p_port"], value: int) -> None: ...
    @overload
    ...
    @overload
    def get(self, option: Literal["libtorrent/i2p"]) -> bool: ...
    @overload
    def get(self, option: Literal["libtorrent/i2p_hostname"]) -> str: ...
    @overload
    def get(self, option: Literal["libtorrent/i2p_port"]) -> int: ...
    @overload
